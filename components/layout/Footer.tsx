...
export default function Footer() {
  return (
    <footer className="bg-text-primary text-white/70 pt-12 md:pt-14 pb-8">
      <div className="w-full max-w-site mx-auto px-4 sm:px-6 lg:px-10">
        {/* Brand row on mobile — full width */}
        <div className="mb-8">
          <div className="font-sans font-bold text-xl text-white mb-2">
        ...
        <div className="grid grid-cols-3 lg:grid-cols-3 gap-6 mb-8">
          <div className="flex flex-col gap-2.5">
            <h5 className="text-[11px] sm:text-[13px] text-white uppercase tracking-[.08em] font-medium mb-0.5">
              Explore
            </h5>
            {[
              ...
              <Link key={l.href} href={l.href} className="text-[13px] sm:text-sm opacity-70 hover:opacity-100 hover:text-white transition-opacity duration-[250ms]">
                {l.label}
              </Link>
            ))}
          </div>
